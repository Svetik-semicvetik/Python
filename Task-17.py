...
if __name__ == '__main__':
    ...
    a_company = Company('IBS', 'IT')
    b_company = Company('Apple', 'IT')
    Ivan.get_job(a_company) # первый сотрудник получил работу в компании а
    print(1, a_company.position_is_occupied())
    print(2, a_company.staff())
    Olga.get_job(b_company) # второй сотрудник получил работу в компании b
    print(3, b_company.position_is_occupied())
    print(4, b_company.staff())
    Aleksandr.get_job(a_company) # третий сотрудник попытался получить работу в компании а, но место уже занято
    print(5, a_company.position_is_occupied())
    print(6, a_company.staff())
